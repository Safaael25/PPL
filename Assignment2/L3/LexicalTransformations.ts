import {  ProcExp, Exp, Program, CExp, Binding, makeIfExp, makeAppExp, makePrimOp, makeVarDecl, makeVarRef, makeBoolExp, makeLitExp, makeProcExp, isNumExp, isBoolExp, isStrExp, isPrimOp, isVarRef, isLitExp, isIfExp, isProcExp, isClassExp, isAppExp, isLetExp, isAtomicExp, isCExp, isDefineExp, makeDefineExp, DefineExp, isProgram, isExp, makeProgram, makeBinding, LetExp, makeLetExp,  ClassExp } from "./L3-ast";
...
/*
Purpose: TO Transform ClassExp to ProcExp
...
export const class2proc = (exp: ClassExp): ProcExp => 
    ...
    makeProcExp(exp.fields, [makeProcExp([makeVarDecl("msg")],//L31
            [reduce
                (
